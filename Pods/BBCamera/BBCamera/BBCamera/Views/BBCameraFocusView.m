...
@interface BBCameraFocusView () {
}

@end

const static CGFloat BBCameraFocusSize = 50.0f;

@implementation BBCameraFocusView
#pragma mark - init
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, BBCameraFocusSize, BBCameraFocusSize)];
        UIView *subview = [[UIView alloc] initWithFrame:CGRectMake(0, 0, BBCameraFocusSize - 20, BBCameraFocusSize - 20)];
        
        view.tag = subview.tag = -1;
        view.center = subview.center = CGPointMake(CGRectGetMidX(self.bounds), CGRectGetMidY(self.bounds));
        view.layer.borderColor = subview.layer.borderColor = [BBCameraColor tintColor].CGColor;
