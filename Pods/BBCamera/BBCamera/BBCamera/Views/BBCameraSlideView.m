...
#import "BBCameraSlideView.h"

@interface BBCameraSlideView () <BBCameraSlideViewProtocol>
...
@implementation BBCameraSlideView

static NSString* const kExceptionName = @"BBCameraSlideViewException";
static NSString* const kExceptionMessage = @"Invoked abstract method";

#pragma mark -
#pragma mark - Public methods

+ (void)showSlideUpView:(BBCameraSlideView *)slideUpView slideDownView:(BBCameraSlideView *)slideDownView atView:(UIView *)view completion:(void (^)(void))completion
{
...
+ (void)hideSlideUpView:(BBCameraSlideView *)slideUpView slideDownView:(BBCameraSlideView *)slideDownView atView:(UIView *)view completion:(void (^)(void))completion
{
...
#pragma mark -
#pragma mark - BBCameraSlideViewProtocol
