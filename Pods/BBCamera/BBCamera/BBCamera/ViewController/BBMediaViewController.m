...
@interface BBMediaViewController ()
/**
 *  顶部工具条
 */
 ...
 *  资源文件
 */
@property (nonatomic ,strong) BBMediaFileModel *mediaFile;

@end

@implementation BBMediaViewController

+ (instancetype)newWithDelegate:(id<BBCameraDelegate>)delegate mediaFile:(BBMediaFileModel *)mediaFile {
    BBMediaViewController *viewController = [BBMediaViewController new];
    if (viewController) {
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [BBCameraColor bottomBgColor];
...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = [BBCameraColor topBgColor];
    }
    return _topView;
}
...
- (UIView *)bottomView {
    if (!_bottomView) {
        ...
        _bottomView.backgroundColor = [BBCameraColor bottomBgColor];
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        _closeButton = [UIButton BBcCreateButtonWithImage:@"CameraBack.png"
...
- (UIButton *)stickerButton {
    if (!_stickerButton) {
        _stickerButton = [UIButton BBcCreateButtonWithImage:@"CameraSticker.png"
...
- (UIButton *)filterButton {
    if (!_filterButton) {
        _filterButton = [UIButton BBcCreateButtonWithImage:@"CameraFilter.png"
...
- (UIButton *)confirmButton {
    if (!_confirmButton) {
        _confirmButton = [UIButton BBcCreateButtonWithImage:@"CameraShot.png"
