 ...
 *  @return UIColor
 */
- (UIColor *)sectionHeaderTitleColorForImagePickerController:(BBImagePickerController *)picker;
 ...
 *  @return UIColor
 */
- (UIColor *)sectionHeaderBackColorForImagePickerController:(BBImagePickerController *)picker;
