...
@implementation PHAsset (BBExpand)
...
+(void)saveImageToCameraRoll:(UIImage*)image location:(CLLocation*)location completionBlock:(PHAssetAssetBoolBlock)completionBlock{
    ...
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{
        ...
        if(success){
            PHAsset *asset = [self getAsseBBromlocalIdentifier:placeholderAsset.localIdentifier];
...
+(PHAsset*)getAsseBBromlocalIdentifier:(NSString*)localIdentifier{
