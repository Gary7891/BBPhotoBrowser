...
@interface BBMomentHeaderNomalView ()


@end

@implementation BBMomentHeaderNomalView
...
- (UIButton *)selectedButton {
    if (!_selectedButton) {
        ...
        [_selectedButton setTitle:BBPhotoBrowserLocalizedStrings(@"Select all") forState:UIControlStateNormal];
        [_selectedButton setTitle:BBPhotoBrowserLocalizedStrings(@"Deselect all") forState:UIControlStateSelected];
...
@implementation BBMomentHeaderDetailView
...
@implementation BBMomentHeaderModel
