...
@interface BBLibraryCollectionViewCell() {
}
...
@property (nonatomic ,strong) BBCollectionOverlayProgressView *progressView;
...
@implementation BBLibraryCollectionViewCell
...
- (void)setupViews {
    ...
    self.progressView = [[BBCollectionOverlayProgressView alloc] initWithFrame:self.contentView.bounds];
    self.progressView.hidden = YES;
    [self.contentView addSubview:self.progressView];
    
    
    UIImage *image = [UIImage imageNamed:@"BBLibraryResource.bundle/images/BBLibraryCollectionSelected.png"];
    CGFloat imageWidth = image.size.width;
    UIButton *selectedButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [selectedButton setImage:[UIImage imageNamed:@"BBLibraryResource.bundle/images/BBLibraryCollectionUnSelected.png"] forState:UIControlStateNormal];
...
- (void)setThumbnailImage:(UIImage *)thumbnailImage imageResultIsInCloud:(BOOL)imageResultIsInCloud {
    ...
    self.iCloudBadgeImageView.image = imageResultIsInCloud?[UIImage imageNamed:@"BBLibraryResource.bundle/images/BBLibraryCollectioniCloud.png"]:nil;
